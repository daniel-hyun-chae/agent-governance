...
- Product-specific rules live in `project/.opencode-overrides/rules/product-guidelines.md`.
...
- Product-specific gate items satisfied (see `project/.opencode-overrides/rules/product-guidelines.md`).
